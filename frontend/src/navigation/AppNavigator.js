...
import ListarAvisosScreen from '../screens/ListarAvisosScreen';
  ...
  return (
    <NavigationContainer>
      <Stack.Navigator initialRouteName="Login">
        ...
        {/* Módulo de Avisos */}
        <Stack.Screen name="ListarAvisos" component={ListarAvisosScreen} options={{ title: 'Mural de Avisos' }} />
        <Stack.Screen name="CriarAviso" component={CriarAvisoScreen} options={{ title: 'Publicar Aviso' }} />
      </Stack.Navigator>
    </NavigationContainer>
  );
}